...
class _UIWidgetsState extends State<UIWidgets> {
  ...
  double _buildPomodoroProgress() {
    ...
    final int remaining =
        widget.controller.remainingSeconds.value.clamp(0, total) as int;
      ...
      body: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            // 左上角 B：牛皮纸经验条及下拉磁贴 (移至 left:75，避免遮挡番茄钟按钮)
            Positioned(top: 20, left: 75, child: _buildExpBarDrop()),

            // 左上角 A：番茄钟按钮及下拉磁贴 (放在经验条后面，确保层级更高)
        ...
        Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              height: _isTomatoExpanded ? 210 : 0,
              width: 200,
                          ...
                          builder: (context, _) {
                            return Stack(
                              ...
                              children: [
                                ...
                                Text(
                                  _formatTime(
                                    widget.controller.remainingSeconds.value,
                                  ),
        ...
        Positioned(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              height: (_isTomatoExpanded && _isPomodoroConfigOpen)
                  ? 240
                  : 0, // 撑开高度
              width: (_isTomatoExpanded && _isPomodoroConfigOpen)
                  ? 170
                  : 0, // 撑开宽度
              clipBehavior: Clip.hardEdge,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                    'assets/images/scroll_rolled.png',
                  ), // 替换为你的卷起图片名
                  fit: BoxFit.contain,
                ),
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            image: _isExpExpanded
                ? const DecorationImage(
                    image: AssetImage(
                      'assets/images/scroll_unrolled.png',
                    ), // 替换为你的展开图片名
                    fit: BoxFit.fill,
                  )
                : null,
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            ...
            if (_isStatsExpanded)
              widget.controller.fetchHistoryData(); // 后端接口依然健在！
          },
          child: AnimatedScale(
